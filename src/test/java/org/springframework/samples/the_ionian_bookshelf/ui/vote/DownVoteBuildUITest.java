...
public class DownVoteBuildUITest {
	  ...
	  @Test
	  public void testDownVoteBuildUI() throws Exception {
	    ...
	    driver.findElement(By.linkText("Builds")).click();
	    driver.findElement(By.linkText("Down Vote Build")).click();
	  }
