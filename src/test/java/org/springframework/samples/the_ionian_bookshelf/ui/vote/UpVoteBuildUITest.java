...
public class UpVoteBuildUITest {
	...
	@Test
	public void testUpVoteBuildUI() throws Exception {
		...
		driver.findElement(By.xpath("//a[contains(text(),'Builds')]")).click();
		driver.findElement(By.linkText("Up Vote Build")).click();
	}
