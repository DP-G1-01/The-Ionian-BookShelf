...
public class UpdateSummonerPositiveUITest {
	...
	@Test
	public void testUpdateSummonerPositiveUI() throws Exception {
		...
		// id=champsId | label=Ashe]]
		driver.findElement(By.xpath("//option[@value='1']")).click();
		driver.findElement(By.id("leagueId")).click();
		new Select(driver.findElement(By.id("leagueId"))).selectByVisibleText("Bronze");
		driver.findElement(By.id("leagueId")).click();
