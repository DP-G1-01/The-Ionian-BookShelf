...
public class CreateRunePageWithoutLoginUITest {
  ...
  @Test
  public void testNewRunePageWithoutLogin() throws Exception {
    ...
    driver.findElement(By.id("name")).sendKeys("New Rune Page 3");
    ...
    driver.findElement(By.id("select 1.25")).click();
    ...
    new Select(driver.findElement(By.id("select 1.75"))).selectByVisibleText("Ingenious Hunter");
    driver.findElement(By.xpath("//option[@value='Ingenious Hunter']")).click();
    ...
    new Select(driver.findElement(By.id("sec2_0_sel"))).selectByVisibleText("Legend: Alacrity");
    driver.findElement(By.xpath("(//option[@value='Legend: Alacrity'])[3]")).click();
    driver.findElement(By.xpath("//button[@type='submit']")).click();
  }
