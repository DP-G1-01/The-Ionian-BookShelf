...
public class CreateNewMessageNegativeUITest {
	...
	@Test
	public void testCreateMessageNegative() throws Exception {
		...
		driver.findElement(By.id("text")).sendKeys("Negative");
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		driver.findElement(By.xpath("//form[@id='add-message-form']/div/div/div")).click();
		assertEquals("el tamaño tiene que estar entre 10 y 500",
				driver.findElement(By.xpath("//form[@id='add-message-form']/div/div/div/span[2]")).getText());
	}
