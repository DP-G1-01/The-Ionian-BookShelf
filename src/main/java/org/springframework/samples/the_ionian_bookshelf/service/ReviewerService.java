...
import org.springframework.samples.the_ionian_bookshelf.repository.ReviewerRepository;
...
public class ReviewerService {
	...
	public Reviewer save(final Reviewer admin) {
		...
		final Reviewer saved = this.reviewerRepository.save(admin);
